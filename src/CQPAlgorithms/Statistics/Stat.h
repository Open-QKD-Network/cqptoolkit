...
namespace cqp
{
    namespace stats
    {
         ...
         */
        class CQPALGORITHMS_EXPORT StatBase
        {
        public:
            /**
             * @brief StatBase
         ...
         */
        class CQPALGORITHMS_EXPORT ProcessingWorker
        {
        public:
            /**
             * @brief Instance
        ...
        template<typename T>
        class CQPALGORITHMS_EXPORT Stat;
         ...
         */
        template<typename T>
        class CQPALGORITHMS_EXPORT IStatCallback
        {
        public:
            /**
             * @brief StatUpdated
         ...
         */
        class CQPALGORITHMS_EXPORT IAllStatsCallback :
        ...
        template<typename T>
        class CQPALGORITHMS_EXPORT Stat : public StatBase,
