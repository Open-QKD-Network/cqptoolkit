...
namespace cqp
{
    ...
    class CQPALGORITHMS_EXPORT PSK : public DataBlock
    {
    public:
        /// Default constructor
        PSK() {}
        ...
        PSK &operator ^=(const T& right) noexcept
        {
             ...
             */
            // do byte by byte
            for(size_t index = 0; (index < size()) && (index < right.size()); index++)
            {
    ...
    /*class CQPALGORITHMS_EXPORT KeyList : public std::vector<PSK>
    {
    public:
