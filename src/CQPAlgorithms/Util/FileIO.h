...
namespace cqp
{
    namespace fs
    {
         ...
         */
        CQPALGORITHMS_EXPORT bool Exists(const std::string& filename);
         ...
         * @return true on success
         */
        CQPALGORITHMS_EXPORT bool ReadEntireFile(const std::string& filename, std::string& output, size_t limit = std::numeric_limits<size_t>::max());
        /**
         ...
         * @return true on success
         */
        CQPALGORITHMS_EXPORT bool WriteEntireFile(const std::string& filename, const std::string& contents);
         ...
         */
        CQPALGORITHMS_EXPORT std::string Parent(const std::string& path);
        /**
         * @brief BaseName
         ...
         */
        CQPALGORITHMS_EXPORT std::string BaseName(const std::string& path);
         ...
         * @return  true on success
         */
        CQPALGORITHMS_EXPORT bool CreateDirectory(const std::string& path);
        /**
         * @brief IsDirectory
         * @param path
         * @return true if the path is a directory
         */
        CQPALGORITHMS_EXPORT bool IsDirectory(const std::string& path);
        /**
         * @brief CanWrite
         * @param path
         * @return true if the path is accessible by the user
         */
        CQPALGORITHMS_EXPORT bool CanWrite(const std::string& path);
        /**
         * @brief MakeTemp
         ...
         */
        CQPALGORITHMS_EXPORT std::string MakeTemp(bool directory = false);
        /**
         * @brief Delete
         ...
         * @return true on success
         */
        CQPALGORITHMS_EXPORT bool Delete(const std::string& path);

        /**
         * @brief GetCurrentPath
         * @return the current working directory
         */
        CQPALGORITHMS_EXPORT std::string GetCurrentPath();
        /**
         * @brief ListChildren
         * @param path
         * @return names of immediate children
         */
        CQPALGORITHMS_EXPORT std::vector<std::string> ListChildren(const std::string& path);
        /**
         * @brief FindGlob
         * @param search search criteria
         * @return items found
         */
        CQPALGORITHMS_EXPORT std::vector<std::string> FindGlob(const std::string& search);
