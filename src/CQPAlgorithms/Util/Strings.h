...
namespace cqp {
    ...
    CQPALGORITHMS_EXPORT std::string Join(const std::vector<std::string>& strings, const std::string& delimiter = "");
     ...
     */
    CQPALGORITHMS_EXPORT bool StrEqualI(const std::string& left, const std::string& right);
     ...
     */
    CQPALGORITHMS_EXPORT void SplitString(const std::string& value, std::vector<std::string>& dest, const std::string& separator, size_t startAt = 0);
     ...
     * @param[in] startAt Start point of value
     */
    CQPALGORITHMS_EXPORT void SplitString(const std::string& value, std::unordered_set<std::string>& dest, const std::string& separator, size_t startAt = 0);
     ...
     */
    CQPALGORITHMS_EXPORT void ToDictionary(const std::string& delimited, std::map<std::string, std::string>& dictionary,
     ...
     * @return byte array
     */
    CQPALGORITHMS_EXPORT std::vector<uint8_t> HexToBytes(const std::string& hex);
