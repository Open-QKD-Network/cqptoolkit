...
#include "Algorithms/Datatypes/Keys.h"                       // for KeyID, PSK (ptr only)
#include <chrono>
#include <set>
...
namespace cqp
{
    ...
    namespace keygen
    {
         ...
         */
        class KEYMANAGEMENT_EXPORT IPinCallback
        {
        public:
            /**
             * @brief GetHSMPin
         ...
         */
        class KEYMANAGEMENT_EXPORT HSMStore : public virtual IBackingStore
        {
        public:
            /**
             * @brief HSMStore
