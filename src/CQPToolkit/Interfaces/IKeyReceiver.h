...
namespace cqp
{
     ...
     * @details External interface which will provide a quantom receiver
     */
    class CQPTOOLKIT_EXPORT IKeyReceiver : public virtual IProtocolEvent
    {
    public:
        /// Causes the Key reciever to begin session negotiation and ultimatly transfer key data
        ...
        /// Call this to notify the recieve that the transmitter has finished sending a block
        /// @note Once ready, the reciever should call ReadyToReceive()
