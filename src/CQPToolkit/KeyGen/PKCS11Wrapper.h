...
namespace cqp
{
    ...
    namespace p11
    {
         ...
         */
        CQPTOOLKIT_EXPORT ::CK_RV CheckP11(::CK_RV retVal);
         ...
         * managing cleanup.
         */
        class CQPTOOLKIT_EXPORT Module
        {
        public:
            /**
             * @brief Create
         ...
         */
        class CQPTOOLKIT_EXPORT Session : public std::enable_shared_from_this<Session>
        {
        public:
         ...
         */
        class CQPTOOLKIT_EXPORT AttributeList
        {
        public:
            /**
             * @brief AttributeList
         ...
         */
        class CQPTOOLKIT_EXPORT DataObject
        {
        public:
            /**
             * @brief DataObject
