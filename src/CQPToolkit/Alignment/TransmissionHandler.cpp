...
namespace cqp
{
    namespace align
    {
            ...
            do
            {
                ...
                if(dataReady)
                {
                    if(emissions && !emissions->emissions.empty())
                    {
                        ...
                        const auto markersToSend = min(static_cast<uint64_t>(emissions->emissions.size()), request->numofmarkers());
        ...
        grpc::Status TransmissionHandler::DiscardTransmissions(grpc::ServerContext * ctx, const remote::ValidDetections *request, google::protobuf::Empty *)
        {
            using namespace std;
            ...
            do
            {
                ...
                /*lock scope*/
                {
                    ...
                    receivedDataCv.wait(lock, [&]()
                    {
                        ...
                        return dataReady || ctx->IsCancelled();
                    });
