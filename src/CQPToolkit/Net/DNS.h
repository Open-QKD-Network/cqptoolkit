...
namespace cqp
{
    ...
    namespace net
    {
         ...
         */
        CQPTOOLKIT_EXPORT std::string GetHostname(bool fqdn = true) noexcept;

        /**
         * @brief GetHostIPs
         * @return A list of ip addresses for this host
         */
        CQPTOOLKIT_EXPORT std::vector<IPAddress> GetHostIPs() noexcept;
         ...
         */
        CQPTOOLKIT_EXPORT bool ResolveAddress(const std::string& hostname, IPAddress& ip, bool preferIPv6 = false) noexcept;
