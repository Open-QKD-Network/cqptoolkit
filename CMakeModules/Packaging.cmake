...
if(WIN32 AND NOT UNIX)
    ...
    SET(CPACK_DEBIAN_CQPTOOLKIT_PACKAGE_DEPENDS "cqp-algorithms (>= ${BUILD_VERSION_MAJOR}.${BUILD_VERSION_MINOR})")
    SET(CPACK_DEBIAN_KEYMANAGEMENT_PACKAGE_DEPENDS "cqp-cqptoolkit (>= ${BUILD_VERSION_MAJOR}.${BUILD_VERSION_MINOR})")
    SET(CPACK_DEBIAN_NETWORKING_PACKAGE_DEPENDS "cqp-keymanagement (>= ${BUILD_VERSION_MAJOR}.${BUILD_VERSION_MINOR})")
    ...
    SET(CPACK_DEBIAN_CQPTOOLKITD_PACKAGE_DEPENDS "cqp-algorithmsd (>= ${BUILD_VERSION_MAJOR}.${BUILD_VERSION_MINOR})")
    SET(CPACK_DEBIAN_KEYMANAGEMENTD_PACKAGE_DEPENDS "cqp-cqptoolkitd (>= ${BUILD_VERSION_MAJOR}.${BUILD_VERSION_MINOR})")
    SET(CPACK_DEBIAN_NETWORKINGD_PACKAGE_DEPENDS "cqp-keymanagementd (>= ${BUILD_VERSION_MAJOR}.${BUILD_VERSION_MINOR})")
